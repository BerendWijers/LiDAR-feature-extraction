...
import pcfeatures_v3_speedtest

from pcfeatures_v3_speedtest import par_calc
...
from lidar_funcs_v2_speedtest import hasNumbers, pt_density_est, auto_k, mp_preprocessing, auto_chunk
...
if __name__ == "__main__":
    ...
    input_rows = 500000000 #100 million
    testrun = 0
...
#Filtering / classification settings
    ...
    for i in range(0,len(input_file_path)):
       ...
       #%%
        ...
        mod_time = time.time()
        index_order = mp_preprocessing(len(points))
...
# =============================================================================
        ...
        if classification is True:
            ...
            setattr(out_LAS,'classification'+"_"+str(k),point_cloud_prop['class'])
